...
if not st.session_state['user_details'].get('name'):
...
if 'user_details' in st.session_state and st.session_state['user_details'].get('name'):
    ...
    st.markdown("Feel free to ask any questions or share your concerns.")
...
def get_book_summary(book_name):
    prompt = f"Please provide a concise summary of the book: '{book_name}' and its importance to mental health."
